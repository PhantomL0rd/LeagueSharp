...
namespace Shen
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            MenuExtras.AddItem(new MenuItem("InterruptSpellsE", "Interrupt: Taunt").SetValue(true));
            MenuExtras.AddItem(new MenuItem("InterruptSpellsEF", "Interrupt: Flash + Taunt").SetValue(true));
            ...
            Config.AddSubMenu(new Menu("Drawings", "Drawings"));
            {
                ...
                Config.SubMenu("Drawings").AddItem(new MenuItem("DrawEF", "Flash + Taunt Range").SetValue(new Circle(false, System.Drawing.Color.Gray)));
            ...
            Config.AddSubMenu(new Menu("Speech", "Speech"));
            {
                ...
                {
                    Config.SubMenu("Speech").SubMenu("SpeechTest").AddItem(new MenuItem("SpeechText", "Zed needs your help press " + xKey + " for ultimate!"));
            ...
            Game.PrintChat(String.Format("<font color='#70DBDB'>Phantoml0rd's Shen </font> <font color='#FFFFFF'>{0}</font> <font color='#70DBDB'> Enjoy! Updated 5.6</font>", ChampionName));
